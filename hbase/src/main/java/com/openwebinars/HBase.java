		...
		try {
			...
			if (!admin.tableExists(TableName.valueOf("pedidos"))) {
				...
				p.addColumn(Bytes.toBytes("datosCliente"),
						Bytes.toBytes("nombre"), Bytes.toBytes("Abraham"));

				p.addColumn(Bytes.toBytes("datosCliente"),
						Bytes.toBytes("apellido"), Bytes.toBytes("Requena"));

				p.addColumn(Bytes.toBytes("datosPedido"),
						Bytes.toBytes("articulo"), Bytes.toBytes("GPS"));

				p.addColumn(Bytes.toBytes("datosPedido"),
						Bytes.toBytes("precio"), Bytes.toBytes("99,5"));
